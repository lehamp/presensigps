    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td>
                    <span id="title">
                        REKAP PRESENSI GTK<br>
                        PERIODE {{ strtoupper($namabulan[$bulan]) }} {{ $tahun }}<br>
                        SMK YP 17 SELOREJO<br>
                    </span>
                    <span><i>Jln. Raya Selorejo No. 48, Kec. Selorejo Kab. Blitar</i></span>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="margin-top:100px">
            <tr>
                <td></td>
                <td style="text-align: center">Selorejo, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
                <td style="text-align: center; vertical-align:bottom" height="100px">
                    <u>SUTAJI WIDYANTO, S. Pd, M.M</u><br>
                    <i><b>Kepala SMK YP 17 Selorejo</b></i>
                </td>
                <td style="text-align: center; vertical-align:bottom">
                    <u>Nama</u><br>
                    <i><b>TIM TATIB SMK</b></i>
                </td>
            </tr>
        </table>
    </section>
